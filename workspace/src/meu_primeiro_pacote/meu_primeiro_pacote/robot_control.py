...
class robot(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().debug ('Definido o nome do nó para "robot"')
    ...
    def run(self):
        ...
        while(rclpy.ok):
            ...
            self.distancia_direita   = min((self.laser[  0: 170])) # -90 a -10 graus
            self.distancia_frente    = min((self.laser[ 170:190])) # -10 a  10 graus
            self.distancia_esquerda  = min((self.laser[190:360])) #  10 a  90 graus
